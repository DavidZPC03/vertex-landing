...
const i18n = {
  es: {
    ...
    "services.1d": "Sitios, portales y aplicaciones web rápidos, seguros y pensados para crecer con su empresa.",
    "services.2t": "Modernización de sistemas",
    "services.2d": "Actualizamos sus sistemas y portales existentes sin interrumpir la operación diaria.",
    "services.3t": "Soporte e infraestructura IT",
    "services.3d": "Mantenimiento, monitoreo y soporte técnico confiable para que nada se detenga.",
    "services.4t": "Consultoría digital",
    "services.4d": "Asesoría estratégica para tomar decisiones de tecnología claras, prácticas y rentables.",
  ...
  en: {
    ...
    "services.1d": "Fast, secure websites, portals and web apps built to grow with your company.",
    "services.2t": "Systems modernization",
    "services.2d": "We upgrade your existing systems and portals without interrupting daily operations.",
    "services.3t": "IT support & infrastructure",
    "services.3d": "Reliable maintenance, monitoring and technical support so nothing ever stops.",
    "services.4t": "Digital consulting",
    "services.4d": "Strategic advice for clear, practical and profitable technology decisions.",
